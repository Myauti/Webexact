...
$inserir = "INSERT INTO resolucoes (atividade_resolvida, id_aluno_resolucao, resposta_tentativa) VALUES ('$id_atividade', '$id_aluno', '$resposta')";
...
$atualizarExito = "UPDATE resolucoes set exito = '$exito' WHERE id_aluno_resolucao = $id_aluno";
$rs_atualizarExito = $conec->query($atualizarExito);
