...
<body>
  <div class="container">
    ...
    <?php } ?>
    <form method="POST" action="../Controller/vincularProfessor.php">
      ...
      <div class="form-group">
        <div class="form-group">
          <select name="professor" class="form-control">
            ...
            <?php
            $sql = "SELECT usuarios.nome, disciplinas.nome AS nome_disc, alunos.usuario_aluno, usuarios.id_usuario from aluno_disciplina
            ...
            while ($row_resultados = mysqli_fetch_assoc($resultado)) { ?>
              <option value="<?php echo $row_resultados['id_professor']; ?>">
                <?php
      ...
      <a href="./Crud/crudVinc.php" class="btn btn-primary">Voltar</a>
