    ...
    <div class="h-75 container d-flex justify-content-around  mt-5">
      <div class="d-flex p-2">
        <?php while ($obj = $rs->fetch_object()) { ?>
          <button onclick="window.location.href = 'aluno.php'" type="button" class="mb-4 rounded btn btn-outline-primary btn-lg ml-xxl-3"><?php echo $obj->nome_disciplina . " " . "-" . " " . $obj->aluno_disciplina_vinculada ?></button>
        <?php } ?>
      </div>
    </div>
  </div>
