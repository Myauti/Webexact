      ...
      <form action="../Controller/cadastrarAluno.php" method="POST">
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text"  class="form-control" name="cpf" maxlength="11" minlength="11" placeholder="Apenas números">
          </div>
          <div class="form-group col-md-6">
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" name="telefone" placeholder="(xx)123456789" class="form-control">
        </div>
        <div class="form-row">
          <div class="form-group col-md-6">
          ...
          <div class="form-group col-md-2">
            ...
            <select name="cursos" class="form-control">
              ...
              <?php
                ...
                while($row_resultados = mysqli_fetch_assoc($resultado)){ ?>
                  <option value="<?php echo $row_resultados['id_curso'];?>">
                    <?php
                      echo $row_resultados['nome']; 
                    ?>
                  </option> 
          ...
          <div class="form-group col-md-2">
            ...
            <input type="date" class="form-control" name="dataIngresso" placeholder="Mês/Dia/Ano">
          </div>
          <div class="form-group col-md-2">
            <label for="dataConclusao">Data de conclusão</label>
            <input type="date" class="form-control" name="dataConclusao" placeholder="Mês/Dia/Ano">
          </div>
          ...
          <div class="form-group col-md-2">
            <label for="situacaoMatricula">Situação de matrícula</label>
            <select name="situacaoMatricula" class="form-control">
              <option selected>Escolher...</option>
              <?php
                $sql = "SELECT * FROM situacoes_matricula";
                $resultado = mysqli_query($conec, $sql);

                while($row_resultados = mysqli_fetch_assoc($resultado)){ ?>
                  <option value="<?php echo $row_resultados['id_situacao_matricula'];?>">
                    <?php
                      echo $row_resultados['situacao']; 
                    ?>
                  </option> 
                  <?php 
                    }
        ...
        <button type="submit" class="btn btn-primary" value="Entrar">Enviar</button>
      </form>
      </div>
