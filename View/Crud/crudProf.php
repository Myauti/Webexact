...
<body>
            ...
            <table class="table">
                <thead class = "thead-dark">
                    <tr>
                        ...
                        <th scope="col">usuario_professor</th>
                        <th scope="col">unidade_ensino_professor</th>
                        <th scope="col">email_profissional</th>
                        <th scope="col">telefone_profissional</th>
                        <th scope="col">matricula</th>
                        <th scope="col">professor_escolaridade</th>
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        <tr>
                        <th scope="row"><?php echo $obj->id_professor; ?></th>
                        <th scope="row"><?php echo $obj->usuario_professor; ?></th>
                        <th scope="row"><?php echo $obj->unidade_ensino_professor; ?></th>
                        <th scope="row"><?php echo $obj->email_profissional; ?></th>
                        <th scope="row"><?php echo $obj->telefone_profissional; ?></th>
    ...
    <script>
        function excluir(id_professor){
            if (confirm("Deseja excluir esse usuario?")) {
                window.location.href = "../../Controller/CrudDelete/delProf.php?id_professor=" + id_professor;
            }
        }
