...
<body>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <table class="table">
                <thead class = "thead-dark">
                    <tr>
                        <th scope="col">id_escolaridade</th>
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        <tr>
                        <th scope="row"><?php echo $obj->id_escolaridade; ?></th>
                        <th scope="row"><?php echo $obj->escolaridade; ?></th>
                        <td>
                            <a href="./editCrud/editEsc.php?id_escolaridade=<?php echo $obj->id_escolaridade; ?>" class="btn btn-sm btn-warning" > Editar </a>
                            <a href="#" onclick="excluir(<?php echo $obj->id_escolaridade; ?>)" class="btn btn-sm btn-danger" > Excluir </a>
    ...
    <script>
        function excluir(id_escolaridade){
            if (confirm("Deseja excluir?")) {
                window.location.href = "../../Controller/CrudDelete/delEsc.php?id_escolaridade=" + id_escolaridade;
            }
        }
