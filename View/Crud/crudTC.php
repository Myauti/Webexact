...
<body>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        <tr>
                        <th scope="row"><?php echo $obj->id_turno; ?></th>
                        <th scope="row"><?php echo $obj->turno; ?></th>
                        <td>
                            <a href="./editCrud/editTC.php?id_turno=<?php echo $obj->id_turno; ?>" class="btn btn-sm btn-warning" > Editar </a>
                            <a href="#" onclick="excluir(<?php echo $obj->id_turno; ?>)" class="btn btn-sm btn-danger" > Excluir </a>
    ...
    <script>
        function excluir(id_turno){
            if (confirm("Deseja excluir?")) {
                window.location.href = "../../Controller/CrudDelete/delMatr.php?id_turno=" + id_turno;
            }
        }
