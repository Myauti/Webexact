...
<body>
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        ...
                        <td>
                            ...
                            <a href="#" onclick="excluir(<?php echo $obj->id_aluno_disciplina; ?>)" class="btn btn-sm btn-danger" > Excluir </a>
    ...
    <script>
        function excluir(id_aluno_disciplina){
            if (confirm("Deseja excluir realmente?")) {
                window.location.href = "../../Controller/CrudDelete/delDiscAlu.php?id_aluno_disciplina=" + id_aluno_disciplina;
            }s
        }
