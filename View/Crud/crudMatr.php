...
<body>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <table class="table">
                <thead class = "thead-dark">
                    <tr>
                        <th scope="col">id_situacao_matricula</th>
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        <tr>
                        <th scope="row"><?php echo $obj->id_situacao_matricula; ?></th>
                        <th scope="row"><?php echo $obj->situacao; ?></th>
                        <td>
                            <a href="./editCrud/editMatr.php?id_situacao_matricula=<?php echo $obj->id_situacao_matricula; ?>" class="btn btn-sm btn-warning" > Editar </a>
                            <a href="#" onclick="excluir(<?php echo $obj->id_situacao_matricula; ?>)" class="btn btn-sm btn-danger" > Excluir </a>
    ...
    <script>
        function excluir(id_situacao_matricula){
            if (confirm("Deseja excluir?")) {
                window.location.href = "../../Controller/CrudDelete/delMatr.php?id_situacao_matricula=" + id_situacao_matricula;
            }
        }
