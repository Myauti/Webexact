...
<body>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <table class="table">
                <thead class = "thead-dark">
                    <tr>
                        <th scope="col">id_disciplinas</th>
                        <th scope="col">nome</th>
                        <th scope="col">curso_disciplina</th>
                        <th scope="col">periodos_disciplina</th>
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        <tr>
                        <th scope="row"><?php echo $obj->id_disciplinas; ?></th>
    ...
    <script>
        function excluir(id_disciplinas){
            if (confirm("Deseja excluir essa disciplina?")) {
                window.location.href = "delDisc.php?id_disciplina=" + id_disciplinas;
            }
        }
