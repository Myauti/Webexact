            ...
            <table class="table">
                <thead class = "thead-dark">
                    <tr>
                        ...
                        <th scope="col">disciplina_atividade</th>
                        <th scope="col">descricao</th>
                        <th scope="col">categoria_atividade</th>
                        <th scope="col">data_inicio</th>
                        <th scope="col">data_fim</th>
                        <th scope="col">atividade_resposta</th>
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        <tr>
                        <th scope="row"><?php echo $obj->id_atividades; ?></th>
                        <th scope="row"><?php echo $obj->nome; ?></th>
                        <th scope="row"><?php echo $obj->disciplina_atividade ;?></th>
                        <th scope="row"><?php echo $obj->descricao ;?></th>
                        <th scope="row"><?php echo $obj->categoria_atividade ;?></th>
                        <th scope="row"><?php echo $obj->data_inicio ;?></th>
                        <th scope="row"><?php echo $obj->data_fim ;?></th>
                        <th scope="row"><?php echo $obj->atividade_resposta ;?></th>
                        <td>
                            <a href="./EditCrud/editAtiv.php?id_atividades=<?php echo $obj->id_atividades; ?>" class="btn btn-sm btn-warning" > Editar </a>
                            <a href="#" onclick="excluir(<?php echo $obj->id_atividades; ?>)" class="btn btn-sm btn-danger" > Excluir </a>
