...
<body>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        <tr>
                        <th scope="row"><?php echo $obj->id_unidade; ?></th>
                        <th scope="row"><?php echo $obj->nome; ?></th>
                        <th scope="row"><?php echo $obj->sigla; ?></th>
                        <th scope="row"><?php echo $obj->telefone; ?></th>
                        <th scope="row"><?php echo $obj->email; ?></th>
                        <th scope="row"><?php echo $obj->logradouro; ?></th>
                        <th scope="row"><?php echo $obj->numero; ?></th>
                        <th scope="row"><?php echo $obj->complemento; ?></th>
                        <th scope="row"><?php echo $obj->bairro; ?></th>
                        <th scope="row"><?php echo $obj->cidade; ?></th>
                        <th scope="row"><?php echo $obj->estado; ?></th>
                        <th scope="row"><?php echo $obj->cep; ?></th>
                        
                        <td>
                            <a href="./editCrud/editUnid.php?id_unidade=<?php echo $obj->id_unidade; ?>" class="btn btn-sm btn-warning" > Editar </a>
                            <a href="#" onclick="excluir(<?php echo $obj->id_unidade; ?>)" class="btn btn-sm btn-danger" > Excluir </a>
    ...
    <script>
        function excluir(id_unidade){
            if (confirm("Deseja excluir?")) {
                window.location.href = "../../Controller/CrudDelete/delUnid.php?id_unidade=" + id_unidade;
            }
        }
