...
<body>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <table class="table">
                <thead class = "thead-dark">
                    <tr>
                        <th scope="col">id_categoria_atividades</th>
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        <tr>
                        <th scope="row"><?php echo $obj->id_categoria_atividades; ?></th>
                        <th scope="row"><?php echo $obj->nome; ?></th>
                        <td>
                            <a href="./editCrud/editCat.php?id_categoria_atividades=<?php echo $obj->id_categoria_atividades; ?>" class="btn btn-sm btn-warning" > Editar </a>
                            <a href="#" onclick="excluir(<?php echo $obj->id_categoria_atividades; ?>)" class="btn btn-sm btn-danger" > Excluir </a>
    ...
    <script>
        function excluir(id_categoria_atividades){
            if (confirm("Deseja excluir essa categoria?")) {
                window.location.href = "../../Controller/CrudDelete/delCat.php?id_categoria_atividades=" + id_categoria_atividades;
            }
        }
