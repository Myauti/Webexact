...
<body>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        <tr>
                        <th scope="row"><?php echo $obj->id_uf; ?></th>
                        <th scope="row"><?php echo $obj->sigla; ?></th>
                        <th scope="row"><?php echo $obj->estado; ?></th>

                        <td>
                            <a href="./editCrud/editUF.php?id_uf=<?php echo $obj->id_uf; ?>" class="btn btn-sm btn-warning" > Editar </a>
                            <a href="#" onclick="excluir(<?php echo $obj->id_uf; ?>)" class="btn btn-sm btn-danger" > Excluir </a>
    ...
    <script>
        function excluir(id_uf){
            if (confirm("Deseja excluir?")) {
                window.location.href = "../../Controller/CrudDelete/delUF.php?id_uf=" + id_uf;
            }
        }
