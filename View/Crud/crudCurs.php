...
<body>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php while($obj = $rs->fetch_object()) { ?>
                        <tr>
                        <th scope="row"><?php echo $obj->id_curso; ?></th>
                        <th scope="row"><?php echo $obj->nome; ?></th>
                        <th scope="row"><?php echo $obj->turno_curso; ?></th>
                        <th scope="row"><?php echo $obj->periodos; ?></th>
                        <th scope="row"><?php echo $obj->unidade; ?></th>
                        <td>
                            <a href="./editCrud/editCurs.php?id_curso=<?php echo $obj->id_curso; ?>" class="btn btn-sm btn-warning" > Editar </a>
                            <a href="#" onclick="excluir(<?php echo $obj->id_curso; ?>)" class="btn btn-sm btn-danger" > Excluir </a>
    ...
    <script>
        function excluir(id_curso){
            if (confirm("Deseja excluir esse curso?")) {
                window.location.href = "../../Controller/CrudDelete/delCurs.php?id_curso=" + id_curso;
            }
        }
